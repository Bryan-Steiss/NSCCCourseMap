    ...
    public partial class CreateAllTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Intructors", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AdvisingAssignments_Intructors_InstructorId",
                        column: x => x.InstructorId,
                        principalTable: "Intructors",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CourseOfferings_Intructors_InstructorId",
                        column: x => x.InstructorId,
                        principalTable: "Intructors",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseOfferings_CourseId_DiplomaYearSectionId_InstructorId_SemesterId",
                table: "CourseOfferings",
                columns: new[] { "CourseId", "DiplomaYearSectionId", "InstructorId", "SemesterId" },
                unique: true,
